...
<head>
    ...
    <title>Edit Berita - Dapoer Mba ReTe</title>
    ...
    <style>
        ...
        * {
        ...
        .preview-box {
            margin-top: 10px;
            border-radius: 20px;
            background: rgba(242, 240, 168, 0.45);
            padding: 12px;
            display: flex;
            align-items: center;
            gap: 12px;
        ...
        <main class="main">
            ...
            <section class="page-head">
                <div class="page-title">
                    <h1>Edit Berita</h1>
                    <p>Perbarui informasi berita Dapoer Mba ReTe yang sudah dipublikasikan.</p>
                </div>
            ...
            <section class="content-card">
                <form action="{{ route('owner.berita.update', $berita->id) }}" method="POST" enctype="multipart/form-data" class="form-grid">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input
                                ...
                                name="tanggal_terbit"
                                class="form-control"
                                value="{{ old('tanggal_terbit', $berita->tanggal_terbit) }}"
                                required
                            >
                        ...
                        <div class="form-group">
                            ...
                            @if($berita->gambar)
                                <div class="preview-box">
                                    ...
                                    <span>Gambar saat ini. Upload gambar baru jika ingin menggantinya.</span>
                                </div>
                            @else
                                <div class="preview-box">
                                    <img src="{{ asset('assets/images/logo.png') }}" alt="{{ $berita->judul }}">
                                    <span>Belum ada gambar khusus. Sistem akan memakai logo sebagai fallback.</span>
                                </div>
                            @endif
